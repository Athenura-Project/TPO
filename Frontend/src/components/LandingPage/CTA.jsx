    ...
    <React.Fragment>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p
            ...
            className={`animate-on-scroll text-lg md:text-xl text-[#F5F7F2]/80 max-w-2xl mx-auto font-medium mb-10 leading-relaxed transition-all duration-700 ease-out delay-150 ${
              visibleItems["cta-desc"]
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-12"
            }`}
          >
            Join top institutions using Athenura to streamline their TPO
            management, track intern performance, and boost placement conversion
            rates.
          </p>
          ...
          <div
            ...
            className={`animate-on-scroll mt-10 flex items-center justify-center space-x-2 text-sm text-[#F5F7F2]/60 font-medium transition-all duration-700 ease-out delay-500 ${
              visibleItems["cta-trust"]
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          >
            <svg
              className="w-5 h-5 text-[#B8CC34]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <footer className="bg-[#F5F7F2] border-t border-[#224D59]/10 pt-16 pb-8 overflow-hidden">
        ...
        transition-all duration-300 hover:-translate-y-0.5"
                  >
                    <div
                      className="w-9 h-9 rounded-lg bg-[#224D59]/8 flex items-center justify-center shrink-0
        group-hover:bg-[#224D59]/15 transition-colors duration-300"
                    >
                      <Mail
                        size={15}
                        strokeWidth={1.8}
                        className="text-[#224D59]"
                      />
                    </div>
                    ...
                    <ExternalLink
                      size={15}
                      strokeWidth={2}
                      className="ml-auto text-[#384022]/30 group-hover:text-[#224D59] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300 shrink-0"
                    />
                  </a>
                </li>
                <li>
