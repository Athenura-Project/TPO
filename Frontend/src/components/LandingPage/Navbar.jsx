            ...
            <div className="hidden md:flex space-x-10 items-center">
              {['Features', 'About', 'Contact'].map((item) => (
                <a
                  ...
                  className="relative group text-gray-600 hover:text-blue-600 font-semibold text-sm transition-colors duration-300"
                >
                  {item}
                  <span className="absolute -bottom-1 left-0 w-full h-[2px] bg-blue-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out origin-left"></span>
                </a>
              ))}
            </div>
            ...
            <div className="flex md:hidden items-center">
              ...
              >
                ...
                <div className="relative w-6 h-6">
                  ...
                  <svg
                    className={`absolute top-0 left-0 w-6 h-6 transition-transform duration-300 ${
                      isMobileMenuOpen ? 'rotate-0 opacity-100 scale-100 text-blue-600' : '-rotate-90 opacity-0 scale-50'
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
