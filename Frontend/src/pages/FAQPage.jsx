...
const FAQPage = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-[#F5F7F2] pt-30 relative transition-opacity duration-700 ease-out ${fadeIn ? "opacity-100" : "opacity-0"}`}
    >
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-10">
        ...
        {/* Page Header */}
        <FadeInUp>
          <div className="mb-12 md:mb-20 lg:mb-30 text-center flex flex-col items-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-center font-extrabold text-[#224D59] tracking-tight mb-6">
              Help Center & FAQ
            </h1>
            <p className="text-lg md:text-xl text-[#384022]/70 text-center max-w-3xl font-medium leading-relaxed">
              Everything you need to know about Athenura. Learn how to manage
              placements, onboard interns, and secure your institutional data.
            </p>
          </div>
        </FadeInUp>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start relative">
          ...
          <aside className="hidden lg:block w-1/4 sticky top-28 self-start flex-shrink-0 z-20">
            <div className="bg-white/60 backdrop-blur-xl border border-[#224D59]/10 rounded-3xl p-6 shadow-[0_10px_30px_rgba(34,77,89,0.03)] relative overflow-hidden">
              ...
              <h3 className="text-xs font-black text-[#224D59] uppercase tracking-widest mb-5 mt-2">
                Categories
              </h3>
                ...
                {faqData.map((category) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <svg
                        className={`w-4 h-4 mr-3 ${isActive ? "text-[#B8CC34]" : "text-current opacity-70"}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
            ...
            <div className="mt-6 bg-gradient-to-br from-[#224D59] to-[#1A3A43] rounded-3xl p-6 shadow-lg relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-[#F5F7F2]/70 text-sm font-medium mb-4">
                  Our support team is ready to assist your institution.
                </p>
                <a
                  href="mailto:support@athenura.com"
                  className="block w-full py-2.5 px-4 bg-[#B8CC34] text-[#224D59] text-sm font-bold text-center rounded-xl hover:bg-white transition-colors duration-300 shadow-sm"
                >
                  Contact Support
                </a>
              </div>
          ...
          <main
            className="w-full lg:w-3/4 z-10 space-y-16 pb-10"
            ref={mainContentRef}
          >
            {faqData.map((category, catIndex) => (
              ...
              >
                <div className="flex items-center mb-8">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-[#224D59]">
                    {category.title}
                  </h2>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="px-6 py-5 sm:px-8 sm:py-6 flex justify-between items-center z-10 relative">
                          <h3
                            className={`text-base sm:text-lg font-bold pr-8 transition-colors duration-300 ${
                              isOpen
                                ? "text-[#224D59]"
                                : "text-[#224D59]/80 group-hover:text-[#224D59]"
                            }`}
                          >
                            {item.q}
                          </h3>
                          ...
                          <div
                            className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-500 border ${
                              isOpen
                                ? "bg-[#224D59] border-[#224D59] text-[#B8CC34] rotate-180"
                                : "bg-[#F5F7F2] border-transparent text-[#224D59] group-hover:bg-[#224D59]/5"
                            }`}
                          >
                            <svg
                              className={`w-4 h-4 transform transition-transform duration-500 ${isOpen ? "rotate-45" : "rotate-0"}`}
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
            ...
            <div className="mt-16 pt-10 border-t border-[#224D59]/10 text-center">
              <h3 className="text-2xl font-bold text-[#224D59] mb-4">
                Didn't find your answer?
              </h3>
              <p className="text-[#384022]/70 font-medium mb-8">
                Reach out to our support team and we'll get back to you shortly.
              </p>
              <a
                href="mailto:support@athenura.com"
                className="inline-flex items-center px-8 py-3.5 rounded-xl bg-white border border-[#224D59]/20 text-[#224D59] font-bold text-base transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-[#B8CC34]/50 group"
              >
                <svg
                  className="w-5 h-5 mr-3 text-[#B8CC34]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
